...
function changeImage(selectedRadio) {
    ...
    const radio4Img = document.getElementsByClassName("radio4")[0].getElementsByTagName("img")[0];
    ...
    if (selectedRadio === "radio1") {
        ...
        radio4Img.src = "/public/images/Ellipse 10.png";
        ...
        radio2Img.src = "/public/images/Ellipse 10.png";
        radio3Img.src = "/public/images/Ellipse 10.png";
        radio4Img.src = "/public/images/Ellipse 11.png";
    }
